...
void Texture::load_from_file(const char *path, bool mipmaps, uint format, uint type)
{
...
void Texture::load_empty_texture(int w, int h, GLenum target, bool mipmaps, uint format, uint type, int filter)
{
    _width = w;
    _height = h;
    _target = target;
