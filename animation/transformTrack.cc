...
TransformTrack::TransformTrack()
    : position(VectorTrack()),
      rotation(QuatTrack()),
      scaling(VectorTrack()),
      id(0) {}

size_t TransformTrack::getId()
{
    return this->id;
}

void TransformTrack::setId(size_t id)
{
    this->id = id;
}

VectorTrack &TransformTrack::getPosTrack()
{
    return this->position;
}
QuatTrack &TransformTrack::getRotationTrack()
{
    return this->rotation;
}
VectorTrack &TransformTrack::getScalingTrack()
{
    return this->scaling;
}
